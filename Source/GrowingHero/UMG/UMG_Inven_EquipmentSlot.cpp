	...
	Super(ObjectInitializer)
{
	...
	ItemDB = LoadObject<UDataTable>(nullptr, TEXT("'/Game/DataBase/InventoryItem_Equipment_DB.InventoryItem_Equipment_DB'"));
}
...
void UUMG_Inven_EquipmentSlot::UpdataSlot(FInventoryEquipment FItem, bool bEmpty)
{
	m_FEuqipItem.CopyStructure(FItem);
